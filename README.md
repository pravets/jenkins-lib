...
1. Поддержка расширений конфигурации.
1. Подготовка информационной базы по версии из хранилища конфигурации, из исходных файлов конфигурации, комбинированный режим (основная ветка - из хранилища, остальные - из исходников. расширения только из исходников).
...
* Общее:
  ...
  * Исходники расширений ожидаются в каталоге `src/cfe` (`srcExtDir`).
    * Набор расширений к сборке определеляется в параметре `extNames`. По-умолчанию пустой массив.
